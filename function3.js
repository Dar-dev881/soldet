...
function chngfont() {
        var font = document.getElementByClassName('play').src;
        if (img.indexOf('play.png')!=-1) {
            document.getElementById('play').src  = 'images/stop.png';
        }
         else {
		...
		bookmarks.forEach(function(item,index){
			...
			if(item.url != ""){
				...
				var html = '<li data-icon="false">'+
						...
						'<img src="icon/kisah.png" />'+ //class="wrap"
...
function resizeAsma2(multiplier) {
	var paragraphs = document.getElementsByClassName("asma");　　　　
	for (var i = 0; i < paragraphs.length; i++) {　　　　
		if (paragraphs[i].style.fontSize == '') {
...
function resizeAsma3(multiplier) {
	var paragraphs = document.getElementsByClassName("asma-bacaan");　　　　
	for (var i = 0; i < paragraphs.length; i++) {　　　　
		if (paragraphs[i].style.fontSize == '') {
...
function resizeAsma4(multiplier) {
	var paragraphs = document.getElementsByClassName("asma-arti");　　　　
	for (var i = 0; i < paragraphs.length; i++) {　　　　
		if (paragraphs[i].style.fontSize == '') {
			paragraphs[i].style.fontSize = "18px";
		}
...
function myArtiAsma() {
    var x = document.getElementsByClassName("asma-arti");
    var i;
    for (i = 0; i < x.length; i++) {
